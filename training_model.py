...
data = pd.read_csv(r"C:\Users\User\Desktop\Uni\Career\KyAssignment\annotations.csv")
...
model.save('my_trained_model.h5')  # This will save the model in the current directory
